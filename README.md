Go to Repository --> Select <> Code dropdown --> Click on Codespaces tab --> Click on + (Create Codespace on Main) --> Github Codespace window will be opened

Then change directory to assignment1
# cd assignment1
